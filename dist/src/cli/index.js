...
program
    ...
    .action(function (source, options) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, extract_1.default(source, options)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, discover_1.default(options)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, server_1.default(options)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
